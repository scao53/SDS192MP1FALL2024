...
I have constructed the mobility and disability dataset from the 2017 NHTS data. This dataset focuses on travel behaviors by travel disability status and other demographic information. The NHTS asks respondents whether they have a medical condition "that makes it difficult to travel outside of home". Those who respond yes are defined to have a travel disability in this project.

Before producing your analysis, you will study the [**NHTS_OUR_DATASET_CODEBOOK**](codebook/NHTS_OUR_DATASET_CODEBOOK.pdf) to select variables for your analysis. To help you make sense of the mobility and disability dataset, I will note that the unit of observation in this dataset is a person. You can review [the user guide](codebook/NHTS2017_UsersGuide_04232019_1.pdf) and [the original codebook](codebook/original_codebook.pdf) to understand the context of the data. 
